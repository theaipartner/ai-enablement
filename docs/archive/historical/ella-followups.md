...
For Gregory's known issues see `docs/archive/historical/known-issues.md`. For Ella's deferred work see `docs/agents/ella/future-ideas.md`.
...
- **Next action:** Nabeel feedback first. Then either M1.4.5 pilot rollout (~30 min: invite @ella to each of Fernando G / Musa / Jenny / Dhamen / Trevor / Art channels via the channel UI) OR M1.4.6 design session for the mention constraint. Step-by-step in `docs/archive/historical/ella_user_token.md` § Deploy + smoke-test runbook.
