...
| **Meta Marketing API** | Meta ad spend/performance (replaced Cortana 2026-06-30) | `META_ACCESS_TOKEN`, `META_AD_ACCOUNT_ID`, `META_API_VERSION` | Company (Meta Business "AI Arbitrage") | Token via Business Settings. ⚠ Current token is a **60-day USER token expiring 2026-08-29** (person-tied) — replace with a permanent **System User** token once the app is registered. Account `act_2293461684485411`. See `docs/runbooks/meta_ads_ingestion.md`. |
