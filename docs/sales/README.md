...
| [`booking-to-close.md`](./booking-to-close.md) | **(Capture layer live 2026-06-19; spine deferred.)** The booking→confirmation→show→close lifecycle. OnceHub now mirrors bookings into `oncehub_bookings` (migration 0092, see `ingestion.md` § OnceHub); the `booking_cycles` spine + Talent closer card that read it are still deferred. |
